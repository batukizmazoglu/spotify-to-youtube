      ...
      <div className="bg-white dark:bg-gray-800 shadow-xl rounded-lg overflow-hidden w-full max-w-4xl">
        ...
        <div className="p-4 sm:p-6 md:p-8 text-center">
          <p className="text-base sm:text-lg mb-6 sm:mb-8 text-gray-600 dark:text-gray-300">
            Easily transfer your Spotify playlists to YouTube Music and access your music on both platforms.
          </p>
          ...
          <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6">
            <div className="p-4 sm:p-6 border border-gray-200 dark:border-gray-700 rounded-lg hover:shadow-md transition-shadow bg-white dark:bg-gray-800">
              ...
              <h2 className="text-lg sm:text-xl font-semibold mb-2 sm:mb-3 text-gray-800 dark:text-white">Connect Your Accounts</h2>
              <p className="text-sm sm:text-base text-gray-600 dark:text-gray-400">Securely connect to your Spotify and YouTube accounts.</p>
            </div>
            ...
            <div className="p-4 sm:p-6 border border-gray-200 dark:border-gray-700 rounded-lg hover:shadow-md transition-shadow bg-white dark:bg-gray-800">
              ...
              <h2 className="text-lg sm:text-xl font-semibold mb-2 sm:mb-3 text-gray-800 dark:text-white">Select Your Playlists</h2>
              <p className="text-sm sm:text-base text-gray-600 dark:text-gray-400">Choose which Spotify playlists you want to transfer.</p>
            </div>
            ...
            <div className="p-4 sm:p-6 border border-gray-200 dark:border-gray-700 rounded-lg hover:shadow-md transition-shadow bg-white dark:bg-gray-800">
              ...
              <h2 className="text-lg sm:text-xl font-semibold mb-2 sm:mb-3 text-gray-800 dark:text-white">Transfer Completed</h2>
              <p className="text-sm sm:text-base text-gray-600 dark:text-gray-400">Selected playlists are transferred to YouTube Music.</p>
            </div>
          </div>
          ...
          <div className="mt-8 sm:mt-12 flex flex-col sm:flex-row items-center justify-center gap-4 bg-gray-50 dark:bg-gray-700/50 p-4 sm:p-6 rounded-lg">
            ...
            <p className="text-xs sm:text-sm text-center sm:text-left text-gray-500 dark:text-gray-400">
              This application is built using the Spotify Web API and YouTube Data API.
            </p>
          </div>
        </div>
      </div>
