...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-center p-6 bg-gradient-to-br from-gray-900 to-gray-800">
      <div className="bg-white dark:bg-gray-800 shadow-xl rounded-lg overflow-hidden max-w-4xl w-full">
        <div className="relative h-40 sm:h-48 md:h-60 w-full bg-gradient-to-r from-green-500 to-blue-600">
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <h1 className="text-4xl sm:text-5xl font-bold text-white text-center px-4 drop-shadow-md">
        ...
        <div className="p-6 md:p-8 text-center">
          ...
          <Link 
            href="/login"
            className="inline-flex items-center bg-blue-600 hover:bg-blue-700 text-white font-medium py-3 px-8 rounded-lg transition-all duration-200 hover:shadow-lg group"
          >
          ...
          <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="p-6 border border-gray-200 dark:border-gray-700 rounded-lg hover:shadow-md transition-shadow bg-white dark:bg-gray-800">
              <div className="rounded-full w-14 h-14 bg-blue-100 dark:bg-blue-900 flex items-center justify-center mx-auto mb-4">
              ...
              <h2 className="text-xl font-semibold mb-3 text-gray-800 dark:text-white">Hesaplarınızı Bağlayın</h2>
              <p className="text-gray-600 dark:text-gray-400">Spotify ve YouTube hesaplarınıza güvenli bir şekilde bağlanın.</p>
            </div>

            <div className="p-6 border border-gray-200 dark:border-gray-700 rounded-lg hover:shadow-md transition-shadow bg-white dark:bg-gray-800">
              <div className="rounded-full w-14 h-14 bg-green-100 dark:bg-green-900 flex items-center justify-center mx-auto mb-4">
              ...
              <h2 className="text-xl font-semibold mb-3 text-gray-800 dark:text-white">Çalma Listelerinizi Seçin</h2>
              <p className="text-gray-600 dark:text-gray-400">Aktarmak istediğiniz Spotify çalma listelerini seçin.</p>
            </div>
            
            <div className="p-6 border border-gray-200 dark:border-gray-700 rounded-lg hover:shadow-md transition-shadow bg-white dark:bg-gray-800">
              <div className="rounded-full w-14 h-14 bg-purple-100 dark:bg-purple-900 flex items-center justify-center mx-auto mb-4">
              ...
              <h2 className="text-xl font-semibold mb-3 text-gray-800 dark:text-white">Aktarım Tamamlandı</h2>
              <p className="text-gray-600 dark:text-gray-400">Seçilen çalma listeleri YouTube Music&apos;e aktarılır.</p>
            </div>
          </div>
          
          <div className="mt-12 flex flex-col sm:flex-row items-center justify-center gap-4 bg-gray-50 dark:bg-gray-700/50 p-6 rounded-lg">
