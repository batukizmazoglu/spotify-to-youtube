...
export default function PlaylistsPage() {
  ...
  return (
    <div className="flex min-h-screen flex-col p-6 bg-gradient-to-br from-gray-100 to-gray-200 dark:from-gray-900 dark:to-gray-800">
      <header className="flex justify-between items-center mb-8 container mx-auto max-w-5xl">
      ...
      <main className="flex-1 container mx-auto max-w-5xl">
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6">
          <div className="mb-6 flex flex-wrap gap-4">
            <div className="flex items-center bg-white dark:bg-gray-700 px-4 py-2 rounded-md shadow-sm border border-gray-200 dark:border-gray-600">
          ...
          {isSpotifyConnected && isYoutubeConnected ? (
            ...
            <div className="bg-yellow-50 border border-yellow-200 dark:bg-yellow-900/20 dark:border-yellow-800 text-yellow-800 dark:text-yellow-200 px-6 py-5 rounded-lg flex flex-col sm:flex-row items-center sm:items-start gap-4">
              ...
              <div>
                <h3 className="text-lg font-medium mb-2">Bağlantı Gerekli</h3>
                <p className="mb-3">Çalma listelerinizi görüntüleyebilmek ve aktarabilmek için hem Spotify hem de YouTube hesaplarınızı bağlamanız gerekmektedir.</p>
                <Link
                  href="/login"
